...
const PROMPT_MAPPING: Record<string, Record<string, Array<{ questionId: string; placeholder?: string; section?: string; fromSacGeral?: boolean; label?: string }>>> = {
  ...
  vendas: {
    ...
    portfolio: [
      { questionId: "planos_comercializados", label: "Planos comercializados (todas as variações)" },
      { questionId: "servicos_adicionais", label: "Serviços adicionais" },
      { questionId: "plano_campeao", label: "Plano campeão" },
      { questionId: "diferenciais_concorrencia", label: "Diferenciais" },
      { questionId: "concorrentes_principais", label: "Concorrentes (CRM)" },
    ],
    metodo: [
      { questionId: "fluxo_vendas_padrao", label: "Fluxo de venda: segue o padrão" },
      { questionId: "fluxo_vendas_alteracoes", label: "Fluxo de venda: alterações" },
      { questionId: "objecoes_padrao", label: "Objeções: segue o padrão" },
      { questionId: "objecoes_texto", label: "Objeções: o que muda" },
      { questionId: "tem_fidelidade", label: "Tem fidelidade" },
      { questionId: "periodo_fidelidade", label: "Período fidelidade" },
      { questionId: "multa_rescisoria", label: "Multa rescisória" },
    ],
    instalacao: [
      { questionId: "tempo_instalacao", label: "Prazo instalação" },
      { questionId: "taxa_instalacao_modelo", label: "Taxa instalação" },
      { questionId: "valor_taxa_instalacao", label: "Valor instalação" },
      { questionId: "agendamento_ia", label: "IA confirma agendamento" },
    ],
    crm: [
      { questionId: "motivos_perda_leads", label: "Motivos de perda (CRM)" },
      { questionId: "followup_vendas_padrao", label: "Follow-up: segue o padrão" },
    ],
  },
};
